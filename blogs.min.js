...
function latestBlog(singleBlog){
     ...
     var singleBlogImage;
     if(incomingImgSource){
        singleBlogImage = incomingImgSource.data.file.url;
     }
     else{
        singleBlogImage = "https://images.360dublincity.com/common/default-blog-thumb.png";
     }
     image.src = singleBlogImage;
     ...
     blogDescription.innerHTML = fn(singleBlog.postSummary,200);
